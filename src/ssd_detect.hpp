...
class Detector {
    public:
        ...
        void Postprocess(cv::Mat& img, const float confidence_threshold, std::vector<vector<float> > detections);  //SSD检测
        void visialization(string blobName); //
    private:
    ...
    private:
        ...
        std::string CLASSES[21] = { "background", "eye", "smoke", "yawn"};
};
#endif
